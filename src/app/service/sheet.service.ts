...
export class SheetService {
  ...
  getSongSheetDetail(id: number): Observable<SongSheetInterface> {
    const params = new HttpParams().set('id', id.toString());
    return this.http.get(this.uri + 'playlist/detail', { params })
      .pipe(map((res: { playlist: SongSheetInterface }) => res.playlist));
  }

  playSheet(id: number): Observable<SongInterface[]> {
